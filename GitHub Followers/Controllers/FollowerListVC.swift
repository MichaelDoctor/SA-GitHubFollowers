...
class FollowerListVC: GFDataLoadingVC {
    ...
    func getFollowers(username: String, page: Int) {
        ...
        NetworkManager.shared.getFollowers(for: username, page: page) { [weak self] result in
            ...
            case .failure(let error):
                self.presentSearchBar(bool: true)
    ...
    func presentSearchBar(bool: Bool) {
        DispatchQueue.main.async {
            self.navigationItem.hidesSearchBarWhenScrolling = bool
        }
    }
    ...
    func addUserToFavorites(user: User) {
        ...
        PersistenceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
            ...
            guard let error = error else {
                self.presentGFAlertOnMainThread(title: "Success!", message: "You have successfully favorited this user 🎉", buttonTitle: "Woo!")
                return
            }
            self.presentGFAlertOnMainThread(title: "Something went wrong", message: error.rawValue, buttonTitle: "OK")
        }
